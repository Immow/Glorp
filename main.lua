...
local window3
function love.load()
	window1 = Container.new({ layout = "vertical", borderColor = { 1, 0, 0, 1 }, backgroundColor = { 1, 0, 0, 0.5 } })
		:addButton({ w = 80, h = 50, label = "test1" })
		:addButton({ w = 50, h = 50, label = "test2" })
	window2 = Container.new({ layout = "vertical", borderColor = { 1, 0, 0, 1 }, backgroundColor = { 0, 1, 0, 0.5 } })

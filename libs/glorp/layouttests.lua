...
local layoutTests2Sub2 = Glorp.newContainer({
	...
	:addElement("image", { image = glorp_alien, id = "glorp_alien" })
...
for i = 1, 10 do
	layoutTests[3]:addElement("button", { label = "test " .. i })
end
...
for i = 1, 20 do
	layoutTests4Sub1:addElement("button", { label = "test " .. i })
end
...
for i = 1, 20 do
	layoutTests4Sub2:addElement("image", { image = glorp_alien })
end
...
for i = 1, 10 do
	layoutTests[5]:addElement("button", { label = "test " .. i })
end
...
layoutTests[6] = Glorp.newContainer({
	...
	:addElement("button", { label = "test" })
	:addElement("image", { image = glorp_alien })
...
for i = 1, 20 do
	layoutTests7Sub1:addElement("button", { label = "test " .. i })
end
...
for i = 1, 20 do
	layoutTests7Sub2:addElement("image", { image = glorp_alien })
end
...
for i = 1, 20 do
	layoutTests8Sub1:addElement("button", { label = "test " .. i })
end
...
for i = 1, 20 do
	layoutTests8Sub2:addElement("image", { image = glorp_alien })
end
